...
public class OrderRepositoryImpl {
    ...
    public List<OrderDetailResponse> getDetail(String billCode) {
        StringBuilder sql = new StringBuilder("select receiver_address, receiver_name, receiver_phone, quantity, product.price * orders.quantity as prices, bill_code , note\n" +
                "from orders\n" +
